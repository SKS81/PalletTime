...
public class SuhieService {
    ...
    public int givMinEnd(int hor1, int min1, int time) {
        return givMinStart(hor1, min1) + time;
    }

    public int givRemMinEnd(int hor1, int min1, int time) {
        int dopHorTime = givMinEnd(hor1, min1, time) / 60;
        int tempMinTime = dopHorTime * 60;
        return givMinEnd(hor1, min1, time) - tempMinTime;
    }

    public int givRemHorEnd(int hor1, int min1, int time) {
        int remHorEnd;
        int dopHorTime = givMinEnd(hor1, min1, time) / 60;
        if (dopHorTime >= 24) {
